...
├── privacy-policy.html   ← placeholder — replace with your real text
└── terms-of-service.html ← placeholder — replace with your real text
```
...
- **Legal pages:** `study-hive-privacy-policy.html` and `study-hive-terms-of-service.html` are
  placeholders so the footer links don't 404. Replace them with your real
  wording before sharing widely.
