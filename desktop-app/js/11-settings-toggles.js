...
(function(){
  ...
  function sergeantBrief(){ var vibe=localStorage.getItem('studyhive-coach-vibe-v1')||'balanced', worry=localStorage.getItem('studyhive-main-worry-v1')||'staying consistent'; var sd=study(); var esc=function(s){ return String(s==null?'':s).replace(/[&<>"']/g, function(c){ return {'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]; }); }; $('sergeantBriefText').innerHTML='<b>Tone:</b> '+esc(vibe)+'<br><b>Main mission:</b> '+esc(worry)+'<br><b>Current streak:</b> '+esc(sd.currentStreak||0)+' days<br><br>Order: pick one task, set a timer, and report back with a reflection.'; $('sergeantBriefPanel').classList.add('show'); }
