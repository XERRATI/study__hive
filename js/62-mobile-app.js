...
(function () {
  ...
  function build() {
    ...
    /* welcome-back: replace the PC welcome on mobile (hide it instantly —
       inline style so no transition window can show both welcomes) */
    var pcWelcome = document.getElementById('welcomeScreen');
    if (pcWelcome) {
      pcWelcome.classList.add('hidden');
      pcWelcome.style.display = 'none';
  ...
  var TOOLS = [
    ...
    ['💧', 'Water', 'waterBtn'], ['🌬️', 'Breathe', 'breathingBtn'], ['🆘', 'Calm', 'sosBtn'],
